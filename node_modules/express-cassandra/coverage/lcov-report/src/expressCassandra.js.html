...
<div class='wrapper'>
  <div class='pad1'>
    <h1>
      <a href="../index.html">All files</a> / <a href="index.html">src</a> expressCassandra.js
    </h1>
    <div class='clearfix'>
      <div class='fl pad1y space-right2'>
        <span class="strong">85.42% </span>
        <span class="quiet">Statements</span>
        <span class='fraction'>164/192</span>
      </div>
      <div class='fl pad1y space-right2'>
      ...
      <div class='fl pad1y space-right2'>
        ...
        <span class='fraction'>152/176</span>
      </div>
    </div>
    <p class="quiet">
...
<a name='L356'></a><a href='#L356'>356</a></td><td class="line-coverage quiet"><span class="cline-any cline-yes">1x</span>
...
<span class="cstat-no" title="statement not covered" >      if (cb &amp;&amp; _.isArray(err) &amp;&amp; err.length &gt; 0) <span class="cstat-no" title="statement not covered" >cb(err[0]);</span></span>
      else <span class="cstat-no" title="statement not covered" >if (cb) <span class="cstat-no" title="statement not covered" >c</span>b(err);</span>
    });
};
&nbsp;
...
&nbsp;
CassandraClient.uuidFromBuffer = <span class="cstat-no" title="statement not covered" ><span class="fstat-no" title="function not covered" >(buf) =&gt; (new cql.types.Uuid(buf));</span></span>
&nbsp;
...
&nbsp;
CassandraClient.timeuuidFromBuffer = <span class="cstat-no" title="statement not covered" ><span class="fstat-no" title="function not covered" >(buf) =&gt; (new cql.types.TimeUuid(buf));</span></span>
&nbsp;
...
<span class="cstat-no" title="statement not covered" >      return cql;</span>
  ...
  close: {
    get() {
<span class="cstat-no" title="statement not covered" >      return CassandraClient.orm.close;</span>
    },
  },
  closeAsync: {
    get() {
...
Object.defineProperties(CassandraClient.prototype, {
  consistencies: {
    get() {
<span class="cstat-no" title="statement not covered" >      return cql.types.consistencies;</span>
    },
  },
  datatypes: {
    get() {
...
<span class="cstat-no" title="statement not covered" >      return cql;</span>
  ...
  closeAsync: {
    get() {
<span class="cstat-no" title="statement not covered" >      return Promise.promisify(this.orm.close);</span>
    },
  },
});
&nbsp;
