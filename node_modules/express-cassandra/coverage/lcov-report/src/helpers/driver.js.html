...
<div class='wrapper'>
  <div class='pad1'>
    <h1>
      <a href="../../index.html">All files</a> / <a href="index.html">src/helpers</a> driver.js
    </h1>
    <div class='clearfix'>
...
&nbsp;
  execute_definition_query(query, callback) <span class="cstat-no" title="statement not covered" >{</span>
<span class="cstat-no" title="statement not covered" >    this.ensure_init(<span class="fstat-no" title="function not covered" >(err) =&gt; {</span></span>
...
<span class="cstat-no" title="statement not covered" >      conn.execute(query, [], { prepare: false, fetchSize: 0 }, callback);</span>
    });
  },
&nbsp;
