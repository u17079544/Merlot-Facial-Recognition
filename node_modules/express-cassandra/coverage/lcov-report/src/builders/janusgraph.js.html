...
<div class='wrapper'>
  <div class='pad1'>
    <h1>
      <a href="../../index.html">All files</a> / <a href="index.html">src/builders</a> janusgraph.js
    </h1>
    <div class='clearfix'>
      <div class='fl pad1y space-right2'>
        <span class="strong">74.56% </span>
        <span class="quiet">Statements</span>
        <span class='fraction'>85/114</span>
      </div>
      <div class='fl pad1y space-right2'>
...
<span class="cstat-no" title="statement not covered" >    this._client.execute(script, bindings, <span class="fstat-no" title="function not covered" >(err, results) =&gt; {</span></span>
...
&nbsp;
      <span class="missing-if-branch" title="else path not taken" >E</span>if (_.isArray(results) &amp;&amp; results.includes(graphName)) {
        callback(null, true);
        return;
      }
...
&nbsp;
      <span class="missing-if-branch" title="if path not taken" >I</span>if (!exist) {
  ...
  put_indexes(graphName, mappingName, indexes, callback) {
    ...
    Object.keys(indexes).forEach((index) =&gt; {
      if (indexes[index].type === 'Composite') {
        ...
        script += `.indexOnly(mgmt.getVertexLabel('${mappingName}'))`;
        <span class="missing-if-branch" title="if path not taken" >I</span>if (indexes[index].unique) {
<span class="cstat-no" title="statement not covered" >          script += '.unique()';</span>
        }
        script += '.buildMixedIndex("search");';
      } else <span class="missing-if-branch" title="else path not taken" >E</span>if (indexes[index].type === 'VertexCentric') {
...
&nbsp;
      <span class="missing-if-branch" title="else path not taken" >E</span>if (Object.keys(mappingBody.indexes).length &gt; 0) {
