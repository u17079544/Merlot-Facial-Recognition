...
<div class='wrapper'>
  <div class='pad1'>
    <h1>
      <a href="../../index.html">All files</a> / <a href="index.html">src/utils</a> parser.js
    </h1>
    <div class='clearfix'>
      <div class='fl pad1y space-right2'>
        <span class="strong">85.99% </span>
        <span class="quiet">Statements</span>
        <span class='fraction'>356/414</span>
      </div>
      <div class='fl pad1y space-right2'>
        <span class="strong">77.89% </span>
        <span class="quiet">Branches</span>
        <span class='fraction'>236/303</span>
      </div>
      <div class='fl pad1y space-right2'>
      ...
      <div class='fl pad1y space-right2'>
        <span class="strong">86.5% </span>
        <span class="quiet">Lines</span>
        <span class='fraction'>346/400</span>
      </div>
    </div>
    <p class="quiet">
...
<a name='L740'></a><a href='#L740'>740</a></td><td class="line-coverage quiet"><span class="cline-any cline-yes">1x</span>
...
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-yes">1x</span>
<span class="cline-any cline-yes">40322x</span>
<span class="cline-any cline-yes">9x</span>
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-yes">40313x</span>
<span class="cline-any cline-yes">33x</span>
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-yes">40280x</span>
<span class="cline-any cline-yes">40280x</span>
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-yes">40280x</span>
<span class="cline-any cline-yes">1x</span>
...
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-yes">40279x</span>
<span class="cline-any cline-yes">40279x</span>
<span class="cline-any cline-yes">2x</span>
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-yes">40277x</span>
...
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-yes">40272x</span>
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-yes">1x</span>
...
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-yes">20015x</span>
<span class="cline-any cline-yes">40184x</span>
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-yes">40179x</span>
<span class="cline-any cline-yes">40179x</span>
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-yes">40179x</span>
...
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-yes">40163x</span>
<span class="cline-any cline-yes">3x</span>
<span class="cline-any cline-no">&nbsp;</span>
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-neutral">&nbsp;</span>
...
<span class="cline-any cline-yes">40163x</span>
<span class="cline-any cline-yes">40163x</span>
<span class="cline-any cline-yes">40162x</span>
<span class="cline-any cline-yes">40146x</span>
<span class="cline-any cline-yes">40146x</span>
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-yes">16x</span>
<span class="cline-any cline-neutral">&nbsp;</span>
...
<span class="cstat-no" title="statement not covered" >      type = diff.rhs;</span>
<span class="cstat-no" title="statement not covered" >      if (normalizedModelSchema.fields[fieldName].typeDef) {</span>
<span class="cstat-no" title="statement not covered" >        type += normalizedModelSchema.fields[fieldName].typeDef;</span>
      }
    } else {
<span class="cstat-no" title="statement not covered" >      type = normalizedModelSchema.fields[fieldName].type;</span>
<span class="cstat-no" title="statement not covered" >      type += diff.rhs;</span>
    }
  } else {
<span class="cstat-no" title="statement not covered" >    type = diff.rhs.type;</span>
<span class="cstat-no" title="statement not covered" >    if (diff.rhs.typeDef) <span class="cstat-no" title="statement not covered" >t</span>ype += diff.rhs.typeDef;</span>
  }
...
<span class="cstat-no" title="statement not covered" >    parser.callback_or_throw(buildError(`model.${operation}.unsetkey`, fieldName), callback);</span>
...
<span class="cstat-no" title="statement not covered" >        throw (buildError(</span>
...
<span class="cstat-no" title="statement not covered" >      fieldValue = instance._get_default_value(fieldName);</span>
<span class="cstat-no" title="statement not covered" >      if (fieldValue === undefined) {</span>
<span class="cstat-no" title="statement not covered" >        return parser.unset_not_allowed('update', schema, fieldName, callback);</span>
      } else <span class="cstat-no" title="statement not covered" >if (!schema.fields[fieldName].rule || !schema.fields[fieldName].rule.ignore_default) {</span>
...
<span class="cstat-no" title="statement not covered" >          parser.callback_or_throw(buildError('model.update.invaliddefaultvalue', fieldValue, fieldName, fieldType), callback);</span>
<span class="cstat-no" title="statement not covered" >          return true;</span>
        }
      }
    }
...
&nbsp;
    if (fieldValue === undefined) {
      ...
      } else <span class="missing-if-branch" title="else path not taken" >E</span>if (!schema.fields[fieldName].rule || <span class="branch-1 cbranch-no" title="branch not covered" >!schema.fields[fieldName].rule.ignore_default) {</span>
        // did set a default value, ignore default is not set
        <span class="missing-if-branch" title="if path not taken" >I</span>if (instance.validate(fieldName, fieldValue) !== true) {
<span class="cstat-no" title="statement not covered" >          parser.callback_or_throw(buildError('model.save.invaliddefaultvalue', fieldValue, fieldName, fieldType), callback);</span>
<span class="cstat-no" title="statement not covered" >          return true;</span>
        }
      }
    }
...
<span class="cstat-no" title="statement not covered" >    throw (buildError('model.find.invalidop', relationKey));</span>
  }
&nbsp;
...
<span class="cstat-no" title="statement not covered" >    throw (buildError('model.find.invalidinop'));</span>
  }
  <span class="missing-if-branch" title="if path not taken" >I</span>if (relationKey === '$token' &amp;&amp; !(relationValue instanceof Object)) {
<span class="cstat-no" title="statement not covered" >    throw (buildError('model.find.invalidtoken'));</span>
  }
&nbsp;
...
<span class="cstat-no" title="statement not covered" >      queryRelations.push(util.format(</span>
        whereTemplate,
...
<span class="cstat-no" title="statement not covered" >      throw (buildError('model.find.invalidtokenop', tokenRelationKey));</span>
    }
&nbsp;
...
<span class="cstat-no" title="statement not covered" >      throw (buildError('model.find.invalidcontainsop'));</span>
    }
...
<span class="cstat-no" title="statement not covered" >      throw (buildError('model.find.invalidcontainskeyop'));</span>
    }
    queryRelations.push(util.format(
      whereTemplate,
      fieldName, operator, '?',
...
<span class="cstat-no" title="statement not covered" >          throw (buildError('model.find.invalidexpr'));</span>
        }
...
<span class="cstat-no" title="statement not covered" >          throw (buildError('model.find.invalidsolrquery'));</span>
        }
      }
      return;
    }
...
<span class="cstat-no" title="statement not covered" >      queryParam = util.format("'%s'", param);</span>
    } else <span class="missing-if-branch" title="if path not taken" >I</span>if (param instanceof Date) {
<span class="cstat-no" title="statement not covered" >      queryParam = util.format("'%s'", param.toISOString());</span>
...
<span class="cstat-no" title="statement not covered" >      queryParam = param.toString();</span>
...
<span class="cstat-no" title="statement not covered" >      queryParam = util.format("'%s'", param.toString());</span>
    } else {
      queryParam = param;
    }
...
<span class="cstat-no" title="statement not covered" >    partitionKeyClause = util.format('"%s"', partitionKey);</span>
  }
&nbsp;
...
<span class="cstat-no" title="statement not covered" >        throw (buildError('model.find.invalidorder'));</span>
      }
...
<span class="cstat-no" title="statement not covered" >          throw (buildError('model.find.invalidordertype', orderItemKeys[i]));</span>
        }
      }
    }
  });
...
<span class="cstat-no" title="statement not covered" >        throw (buildError('model.find.invalidgroup'));</span>
      }
&nbsp;
...
parser.get_limit_clause = function f(queryObject) {
  ...
  Object.keys(queryObject).forEach((k) =&gt; {
    ...
    if (k.toLowerCase() === '$limit') {
      <span class="missing-if-branch" title="if path not taken" >I</span>if (typeof queryItem !== 'number') <span class="cstat-no" title="statement not covered" >throw (buildError('model.find.limittype'));</span>
      limit = queryItem;
    }
  });
