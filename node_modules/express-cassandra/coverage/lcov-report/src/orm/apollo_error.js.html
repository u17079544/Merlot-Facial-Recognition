...
<div class='wrapper'>
  <div class='pad1'>
    <h1>
      <a href="../../index.html">All files</a> / <a href="index.html">src/orm</a> apollo_error.js
    </h1>
    <div class='clearfix'>
...
<span class="branch-1 cbranch-no" title="branch not covered" >  const name = argsarray.length ? argsarray.shift() : '_none_given_';</span>
&nbsp;
...
&nbsp;
  ...
  error.name = <span class="branch-1 cbranch-no" title="branch not covered" >(ERR_NAME_PREFIX ? util.format('%s.', ERR_NAME_PREFIX) : '') + name;</span>
&nbsp;
  return error;
};
&nbsp;
