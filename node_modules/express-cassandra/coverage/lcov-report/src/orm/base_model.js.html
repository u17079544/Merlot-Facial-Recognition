...
<div class='wrapper'>
  <div class='pad1'>
    <h1>
      <a href="../../index.html">All files</a> / <a href="index.html">src/orm</a> base_model.js
    </h1>
    <div class='clearfix'>
      <div class='fl pad1y space-right2'>
        <span class="strong">77.55% </span>
        <span class="quiet">Statements</span>
        <span class='fraction'>501/646</span>
      </div>
      <div class='fl pad1y space-right2'>
        <span class="strong">61.15% </span>
        <span class="quiet">Branches</span>
        <span class='fraction'>181/296</span>
      </div>
      <div class='fl pad1y space-right2'>
        <span class="strong">88.76% </span>
        <span class="quiet">Functions</span>
        <span class='fraction'>79/89</span>
      </div>
      <div class='fl pad1y space-right2'>
        <span class="strong">77.51% </span>
        <span class="quiet">Lines</span>
        <span class='fraction'>486/627</span>
      </div>
    </div>
    <p class="quiet">
...
<a name='L1144'></a><a href='#L1144'>1144</a></td><td class="line-coverage quiet"><span class="cline-any cline-yes">1x</span>
...
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-yes">54x</span>
<span class="cline-any cline-yes">40796x</span>
<span class="cline-any cline-yes">21228x</span>
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-yes">40796x</span>
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-yes">54x</span>
<span class="cline-any cline-yes">40345x</span>
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-yes">54x</span>
<span class="cline-any cline-yes">54x</span>
...
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-yes">100075x</span>
<span class="cline-any cline-yes">20015x</span>
...
<span class="cline-any cline-yes">20015x</span>
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-yes">20013x</span>
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-neutral">&nbsp;</span>
...
<span class="branch-1 cbranch-no" title="branch not covered" >  instanceValues = instanceValues || {};</span>
  const fieldValues = {};
...
<span class="cstat-no" title="statement not covered" >      throw (buildError('model.validator.invalidschema', e.message));</span>
    }
&nbsp;
...
<span class="cstat-no" title="statement not covered" >    throw (buildError('model.tablecreation.invalidname', tableName));</span>
  }
&nbsp;
...
&nbsp;
<span class="cstat-no" title="statement not covered" >      const indexingTasks = [];</span>
&nbsp;
      // cassandra index create if defined
<span class="cstat-no" title="statement not covered" >      if (_.isArray(modelSchema.indexes)) {</span>
<span class="cstat-no" title="statement not covered" >        tableBuilder.createIndexesAsync = Promise.promisify(tableBuilder.create_indexes);</span>
<span class="cstat-no" title="statement not covered" >        indexingTasks.push(tableBuilder.createIndexesAsync(modelSchema.indexes));</span>
      }
...
<span class="cstat-no" title="statement not covered" >        tableBuilder.createCustomIndexesAsync = Promise.promisify(tableBuilder.create_custom_indexes);</span>
<span class="cstat-no" title="statement not covered" >        indexingTasks.push(tableBuilder.createCustomIndexesAsync(modelSchema.custom_indexes));</span>
      }
<span class="cstat-no" title="statement not covered" >      if (modelSchema.custom_index) {</span>
<span class="cstat-no" title="statement not covered" >        tableBuilder.createCustomIndexAsync = Promise.promisify(tableBuilder.create_custom_indexes);</span>
<span class="cstat-no" title="statement not covered" >        indexingTasks.push(tableBuilder.createCustomIndexAsync([modelSchema.custom_index]));</span>
      }
...
<span class="cstat-no" title="statement not covered" >        tableBuilder.createViewsAsync = Promise.promisify(tableBuilder.create_mviews);</span>
<span class="cstat-no" title="statement not covered" >        indexingTasks.push(tableBuilder.createViewsAsync(modelSchema.materialized_views));</span>
      }
&nbsp;
...
<span class="cstat-no" title="statement not covered" >        callback(buildError('model.tablecreation.schemanotfound', tableName));</span>
<span class="cstat-no" title="statement not covered" >        return;</span>
      }
...
<span class="cstat-no" title="statement not covered" >        tableBuilder.init_alter_operations(modelSchema, dbSchema, normalizedModelSchema, normalizedDBSchema, <span class="fstat-no" title="function not covered" >(err1) =&gt; {</span></span>
<span class="cstat-no" title="statement not covered" >          if (err1 &amp;&amp; err1.message === 'alter_impossible') {</span>
<span class="cstat-no" title="statement not covered" >            tableBuilder.drop_recreate_table(modelSchema, normalizedDBSchema.materialized_views, afterDBCreate);</span>
<span class="cstat-no" title="statement not covered" >            return;</span>
          }
<span class="cstat-no" title="statement not covered" >          callback(err1);</span>
        });
...
<span class="cstat-no" title="statement not covered" >    this.init(<span class="fstat-no" title="function not covered" >(err) =&gt; {</span></span>
...
<span class="cstat-no" title="statement not covered" >    throw (new Error('To use elassandra features, set `manageESIndex` to true in ormOptions'));</span>
  }
  return this._properties.esclient;
};
&nbsp;
BaseModel.get_gremlin_client = function f() {
  <span class="missing-if-branch" title="if path not taken" >I</span>if (!this._properties.gremlin_client) {
<span class="cstat-no" title="statement not covered" >    throw (new Error('To use janus graph features, set `manageGraphs` to true in ormOptions'));</span>
  }
...
<span class="cstat-no" title="statement not covered" >    const cb = onReadable;</span>
...
<span class="cstat-no" title="statement not covered" >    throw (buildError('model.find.eachrowerror', 'no valid onReadable function was provided'));</span>
  }
  <span class="missing-if-branch" title="if path not taken" >I</span>if (typeof callback !== 'function') {
<span class="cstat-no" title="statement not covered" >    throw (buildError('model.find.cberror'));</span>
  }
&nbsp;
  const defaults = {
    raw: false,
...
&nbsp;
  this._execute_table_eachRow(selectQuery.query, selectQuery.params, queryOptions, (n, row) =&gt; {
    ...
    <span class="missing-if-branch" title="if path not taken" >I</span>if (err) {
<span class="cstat-no" title="statement not covered" >      callback(buildError('model.find.dberror', err));</span>
<span class="cstat-no" title="statement not covered" >      return;</span>
    }
    callback(err, result);
  });
...
&nbsp;
  <span class="missing-if-branch" title="if path not taken" >I</span>if (typeof onReadable !== 'function') {
<span class="cstat-no" title="statement not covered" >    throw (buildError('model.find.streamerror', 'no valid onReadable function was provided'));</span>
  }
  <span class="missing-if-branch" title="if path not taken" >I</span>if (typeof callback !== 'function') {
<span class="cstat-no" title="statement not covered" >    throw (buildError('model.find.cberror'));</span>
  }
...
<span class="cstat-no" title="statement not covered" >    parser.callback_or_throw(buildError('model.update.before.error'), callback);</span>
<span class="cstat-no" title="statement not covered" >    return {};</span>
  }
&nbsp;
...
&nbsp;
  ...
  <span class="missing-if-branch" title="if path not taken" >I</span>if (options.ttl) <span class="cstat-no" title="statement not covered" >query += util.format(' USING TTL %s', options.ttl);</span>
  query += ' SET %s %s';
  try {
...
<span class="cstat-no" title="statement not covered" >          return buildError('model.update.after.error');</span>
        }
        return true;
      },
    };
...
&nbsp;
  this._execute_table_query(query, finalParams, queryOptions, (err, results) =&gt; {
    <span class="missing-if-branch" title="else path not taken" >E</span>if (typeof callback === 'function') {
      <span class="missing-if-branch" title="if path not taken" >I</span>if (err) {
<span class="cstat-no" title="statement not covered" >        callback(buildError('model.update.dberror', err));</span>
<span class="cstat-no" title="statement not covered" >        return;</span>
      }
      <span class="missing-if-branch" title="if path not taken" >I</span>if (typeof schema.after_update === 'function' &amp;&amp; <span class="branch-1 cbranch-no" title="branch not covered" >schema.after_update(queryObject, updateValues, options) === false) {</span>
<span class="cstat-no" title="statement not covered" >        callback(buildError('model.update.after.error'));</span>
<span class="cstat-no" title="statement not covered" >        return;</span>
      }
      callback(null, results);
    } else <span class="cstat-no" title="statement not covered" >if (err) {</span>
<span class="cstat-no" title="statement not covered" >      throw (buildError('model.update.dberror', err));</span>
...
<span class="cstat-no" title="statement not covered" >      throw (buildError('model.update.after.error'));</span>
    }
  });
&nbsp;
  return {};
...
<span class="cstat-no" title="statement not covered" >    parser.callback_or_throw(buildError('model.delete.before.error'), callback);</span>
<span class="cstat-no" title="statement not covered" >    return {};</span>
  }
&nbsp;
  let queryParams = [];
...
<span class="cstat-no" title="statement not covered" >          return buildError('model.delete.after.error');</span>
        }
        return true;
      },
    };
...
&nbsp;
  this._execute_table_query(query, queryParams, queryOptions, (err, results) =&gt; {
    <span class="missing-if-branch" title="else path not taken" >E</span>if (typeof callback === 'function') {
      <span class="missing-if-branch" title="if path not taken" >I</span>if (err) {
<span class="cstat-no" title="statement not covered" >        callback(buildError('model.delete.dberror', err));</span>
<span class="cstat-no" title="statement not covered" >        return;</span>
      }
      <span class="missing-if-branch" title="if path not taken" >I</span>if (typeof schema.after_delete === 'function' &amp;&amp; <span class="branch-1 cbranch-no" title="branch not covered" >schema.after_delete(queryObject, options) === false) {</span>
<span class="cstat-no" title="statement not covered" >        callback(buildError('model.delete.after.error'));</span>
<span class="cstat-no" title="statement not covered" >        return;</span>
      }
      callback(null, results);
    } else <span class="cstat-no" title="statement not covered" >if (err) {</span>
<span class="cstat-no" title="statement not covered" >      throw (buildError('model.delete.dberror', err));</span>
...
<span class="cstat-no" title="statement not covered" >      throw (buildError('model.delete.after.error'));</span>
    }
  });
&nbsp;
  return {};
...
<span class="cstat-no" title="statement not covered" >  return cql.types;</span>
};
&nbsp;
...
<span class="cstat-no" title="statement not covered" >  return this.constructor.get_keyspace_name();</span>
};
&nbsp;
...
<span class="branch-1 cbranch-no" title="branch not covered" >  this._validators = this._validators || {};</span>
  return <span class="branch-1 cbranch-no" title="branch not covered" >schemer.get_validation_message(this._validators[propertyName] || [], value);</span>
};
&nbsp;
...
<span class="cstat-no" title="statement not covered" >    parser.callback_or_throw(buildError('model.save.before.error'), callback);</span>
<span class="cstat-no" title="statement not covered" >    return {};</span>
  }
&nbsp;
  const {
...
<span class="cstat-no" title="statement not covered" >          return buildError('model.save.after.error');</span>
        }
        return true;
      },
    };
...
&nbsp;
  this.constructor._execute_table_query(query, queryParams, queryOptions, (err, result) =&gt; {
    <span class="missing-if-branch" title="else path not taken" >E</span>if (typeof callback === 'function') {
      <span class="missing-if-branch" title="if path not taken" >I</span>if (err) {
<span class="cstat-no" title="statement not covered" >        callback(buildError('model.save.dberror', err));</span>
<span class="cstat-no" title="statement not covered" >        return;</span>
      }
      ...
      <span class="missing-if-branch" title="if path not taken" >I</span>if (typeof schema.after_save === 'function' &amp;&amp; <span class="branch-1 cbranch-no" title="branch not covered" >schema.after_save(this, options) === false) {</span>
<span class="cstat-no" title="statement not covered" >        callback(buildError('model.save.after.error'));</span>
<span class="cstat-no" title="statement not covered" >        return;</span>
      }
      callback(null, result);
    } else <span class="cstat-no" title="statement not covered" >if (err) {</span>
<span class="cstat-no" title="statement not covered" >      throw (buildError('model.save.dberror', err));</span>
...
<span class="cstat-no" title="statement not covered" >      throw (buildError('model.save.after.error'));</span>
    }
  });
&nbsp;
  return {};
