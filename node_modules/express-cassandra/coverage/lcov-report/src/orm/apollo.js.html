...
<div class='wrapper'>
  <div class='pad1'>
    <h1>
      <a href="../../index.html">All files</a> / <a href="index.html">src/orm</a> apollo.js
    </h1>
    <div class='clearfix'>
      <div class='fl pad1y space-right2'>
        <span class="strong">81.72% </span>
        <span class="quiet">Statements</span>
        <span class='fraction'>237/290</span>
      </div>
      <div class='fl pad1y space-right2'>
        <span class="strong">75.61% </span>
        <span class="quiet">Branches</span>
        <span class='fraction'>93/123</span>
      </div>
      <div class='fl pad1y space-right2'>
      ...
      <div class='fl pad1y space-right2'>
        ...
        <span class='fraction'>232/285</span>
      </div>
    </div>
    <p class="quiet">
...
<span class="cstat-no" title="statement not covered" >  elasticsearch = null;</span>
}
&nbsp;
let gremlin;
try {
...
<span class="cstat-no" title="statement not covered" >  gremlin = null;</span>
}
&nbsp;
let dseDriver;
try {
...
<span class="cstat-no" title="statement not covered" >    throw (buildError('model.validator.invalidconfig', 'Cassandra connection configuration undefined'));</span>
  }
&nbsp;
<span class="branch-1 cbranch-no" title="branch not covered" >  options = options || {};</span>
&nbsp;
...
&nbsp;
  create_es_client() {
    <span class="missing-if-branch" title="if path not taken" >I</span>if (!elasticsearch) {
<span class="cstat-no" title="statement not covered" >      throw (new Error('Configured to use elassandra, but elasticsearch module was not found, try npm install elasticsearch'));</span>
    }
&nbsp;
...
&nbsp;
  create_gremlin_client() {
    <span class="missing-if-branch" title="if path not taken" >I</span>if (!gremlin) {
<span class="cstat-no" title="statement not covered" >      throw (new Error('Configured to use janus graph server, but gremlin module was not found, try npm install gremlin'));</span>
    }
&nbsp;
    const contactPoints = this._connection.contactPoints;
    const defaultHosts = [];
...
<span class="cstat-no" title="statement not covered" >        keyspaceBuilder.create_keyspace(keyspaceName, options.defaultReplicationStrategy, callback);</span>
<span class="cstat-no" title="statement not covered" >        return;</span>
      }
&nbsp;
...
<span class="cstat-no" title="statement not covered" >        keyspaceBuilder.alter_keyspace(keyspaceName, options.defaultReplicationStrategy, callback);</span>
<span class="cstat-no" title="statement not covered" >        return;</span>
      }
&nbsp;
      client.shutdown(() =&gt; {
...
<span class="cstat-no" title="statement not covered" >          udtBuilder.create_udt(udtKey, options.udts[udtKey], udtCallback);</span>
<span class="cstat-no" title="statement not covered" >          return;</span>
        }
&nbsp;
...
<span class="cstat-no" title="statement not covered" >          udfBuilder.create_udf(udfKey, options.udfs[udfKey], udfCallback);</span>
<span class="cstat-no" title="statement not covered" >          return;</span>
        }
&nbsp;
...
&nbsp;
<span class="branch-1 cbranch-no" title="branch not covered" >        const udfInputs = options.udfs[udfKey].inputs ? options.udfs[udfKey].inputs : {};</span>
...
<span class="cstat-no" title="statement not covered" >          udaBuilder.create_uda(udaKey, options.udas[udaKey], udaCallback);</span>
<span class="cstat-no" title="statement not covered" >          return;</span>
        }
&nbsp;
...
<span class="cstat-no" title="statement not covered" >      this._models[i]._properties.cql = this._client;</span>
<span class="cstat-no" title="statement not covered" >      this._models[i]._properties.define_connection = this._define_connection;</span>
    });
  },
&nbsp;
  init(callback) {
...
<span class="cstat-no" title="statement not covered" >        throw (buildError('model.validator.invaliduda', e.message));</span>
      }
    };
&nbsp;
...
<span class="cstat-no" title="statement not covered" >        throw (buildError('model.validator.invalidudf', e.message));</span>
      }
    };
&nbsp;
...
<span class="cstat-no" title="statement not covered" >        throw (buildError('model.validator.invalidudt', e.message));</span>
      }
    };
&nbsp;
...
<span class="cstat-no" title="statement not covered" >      throw (buildError('model.validator.invalidschema', 'Model name must be a valid string'));</span>
    }
&nbsp;
    try {
...
&nbsp;
  getModel(modelName) {
<span class="branch-1 cbranch-no" title="branch not covered" >    return this._models[modelName] || null;</span>
  },
&nbsp;
  close(callback) {
